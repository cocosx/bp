...
\end{description}
\section{Šíření sítě}
Bylo provedeno 100 nezavislých náhodných běhů. Podmínkou ukončení je stabilizace sítě, tj. rovnost dvou po sobě následujících \texttt{revenue}. Získaná data jsou v přiloženém souboru \texttt{spread1.csv}. Z nich odvozené popisné statistiky:
\begin{center}
...
\end{tabular}
\end{center}
Vidíme, že průměrný běh trval 24 kol. Členy sítě se maximálně stalo 217 osob z 300 a nakonec zůstalo 81, tedy přibližne čtvrtina. Časová řada počtu členů jednoho vybraného běhu je na následujícím grafu: 
...
Nabízí se otázka, jakou vlastnost mají agenti, kteří v síti zůstali. Prvním důvodem může být malý \texttt{be-point}, což způsobí výhodnost členství prakticky za jakýchkoliv okolností. Druhým může být nadprůměrný počet přátel. Za stejných podmínek jako v předchozím případě sestavíme experiment. Výsledkem běhu je průměrný počet přátel pro člena sítě a pro všechny osoby. Data jsou k dispozici v souboru \texttt{spread2.csv}. Popisné statistiky:
\begin{center}
\begin{tabular}{|r|r|r|r|}
\hline
